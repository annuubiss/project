...
import { Search, Filter, ChevronDown, Plus, Ticket } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col items-center justify-center gap-4 rounded-3xl bg-card px-6 py-24 text-center shadow-sm ring-1 ring-border">
        ...
        <div className="space-y-1">
          <p className="text-lg font-bold text-foreground">Промокодов пока нет</p>
          <p className="text-[15px] text-muted-foreground">
            Создайте первый промокод, чтобы предлагать клиентам скидки.
          </p>
        </div>
      </div>
    </div>
